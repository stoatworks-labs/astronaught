...
/**
    ...
    is "the effect does nothing", with no message anywhere. Astronaught has four
    ...
    It also records the host clock's unit at frame sixty. See Astronaught.h: the
