...
**[v0.1.3](https://github.com/stoatworks-labs/astronaught/releases/tag/v0.1.3)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`astronaught-0.1.3-macos-universal.dmg`](https://github.com/stoatworks-labs/astronaught/releases/download/v0.1.3/astronaught-0.1.3-macos-universal.dmg) | 233 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`astronaught-0.1.3-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/astronaught/releases/download/v0.1.3/astronaught-0.1.3-windows-x86_64-setup.exe) | 228 KB |
